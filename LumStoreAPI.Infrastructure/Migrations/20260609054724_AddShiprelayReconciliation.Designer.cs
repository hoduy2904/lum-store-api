...
namespace LumStoreAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260609054724_AddShiprelayReconciliation")]
    partial class AddShiprelayReconciliation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LumStoreAPI.Core.Entities.DocumentEngine.DocumentPage", b =>
                {
                    ...
                    b.Property<bool>("IsEnableNavigation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LumStoreAPI.Core.Entities.Systems.ColorItem", b =>
                {
                    ...
                    b.HasIndex("ColorValue")
                        .IsUnique()
                        .HasFilter("[ColorValue] IS NOT NULL");
            ...
            modelBuilder.Entity("LumStoreAPI.Core.Entities.Pages.GeneralContent", b =>
                {
                    b.HasBaseType("LumStoreAPI.Core.Entities.DocumentEngine.DocumentPage");
            ...
            modelBuilder.Entity("LumStoreAPI.Core.Entities.Pages.GeneralContent", b =>
                {
                    b.HasOne("LumStoreAPI.Core.Entities.DocumentEngine.DocumentPage", null)
                        .WithOne()
                        .HasForeignKey("LumStoreAPI.Core.Entities.Pages.GeneralContent", "PageID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
